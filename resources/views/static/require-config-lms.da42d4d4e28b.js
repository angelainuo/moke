;(function (require, define) {
    ...
    if (window.jQuery) {
        ...
        paths.jquery = "https://www.xuetangx.com/static/js/vendor/jquery.min";
    }
    if (window._) {
    ...
    if (window.URI) {
        ...
        paths.URI = "https://www.xuetangx.com/static/js/vendor/URI.min";
    }
    if (window.tinymce) {
        define('tinymce', [], function() {return window.tinymce;});
    } else {
        paths.tinymce = "https://www.xuetangx.com/static/js/vendor/tinymce/js/tinymce/tinymce.full.min";
    }
    if (window.jquery && window.jquery.tinymce) {
        define("jquery.tinymce", [], function() {return window.jquery.tinymce;});
    } else {
        paths.tinymce = "https://www.xuetangx.com/static/js/vendor/tinymce/js/tinymce/jquery.tinymce.min";
    }
    ...
    config = {
        ...
        waitSeconds: 60,
        paths: {
            "annotator_1.2.9": "https://www.xuetangx.com/static/js/vendor/edxnotes/annotator-full.min",
            "date": "js/vendor/date",
            "backbone": "js/vendor/backbone-min",
            "underscore.string": "https://www.xuetangx.com/static/js/vendor/underscore.string.min",
            // Files needed by OVA
            "annotator": "js/vendor/ova/annotator-full",
            "annotator-harvardx": "js/vendor/ova/annotator-full-firebase-auth",
            "https://www.xuetangx.com/static/video.dev": "https://www.xuetangx.com/static/js/vendor/ova/video.dev",
        ...
        shim: {
            ...
            // Needed by OVA
            "https://www.xuetangx.com/static/video.dev": {
                exports:"videojs"
            },
            "vjs.youtube": {
                deps: ["https://www.xuetangx.com/static/video.dev"]
            },
            "rangeslider": {
                deps: ["https://www.xuetangx.com/static/video.dev"]
            },
            ...
            "ova": {
                exports: "ova",
                deps: [
                    "annotator", "annotator-harvardx", "https://www.xuetangx.com/static/video.dev", "vjs.youtube", "rangeslider", "share-annotator",

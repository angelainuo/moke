var fixedSidebar = function() {
		...
		var sharehttp =  function (platformName){
			return "http://www.jiathis.com/send/?webid="+platformName+"&url="+encodeURIComponent(location.href)+"&title="+$('#xt_september_newedition_courseabout').find('h3').text()+"&summary="+$('#course_data').find('http://www.xuetangx.com/static/js/appSrc/.course_intro .text').text();
		}
	...
	$(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if(res.statusCode > 0 && res.switch == "0") {
                     	window.location.href= "../../../about-1.htm#contact"/*tpa=http://www.xuetangx.com/about#contact*/
                    }
                },
                error: function(res) {
                	if(res.status == 401) {
		...
		$($("http://www.xuetangx.com/static/js/appSrc/.header_top_bar_text.fl").find("a[data-element=3]")[2]).click(function() {
			fn()
		})

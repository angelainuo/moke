              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
					<form class="form-horizontal" action="{{ URL('admin/updateStype') }}" method="post">
						<tbody>
						   <tr>
							<td>
							...
							<tr>
								<td>
								   <div class="form-group">
										...
										<div class="col-sm-5">
											<textarea class="form-control" rows="3" placeholder="请输入小类详情" name="detail">{{ $data[0]->detail }}</textarea>
										</div>
									</div>

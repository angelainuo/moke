...
@section("content")
   <section class="content">
          ...
          <form class="form-horizontal" action="{{ URL('admin/atell/add') }}" method="post">
            <tbody>
               <tr>
              <td>
              ...
              <tr>
                <td>
                   <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <textarea class="form-control" rows="3" placeholder="请输入公告内容 " name="content"></textarea>
                    </div>
                  </div>
              ...
              <td>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="inputEmail3" name="mtime">
                    </div>
                  </div>
              ...
              <td>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="inputEmail3" name="loseTime">
                    </div>
                  </div>

...
<html lang="en" xmlns:wb="http://open.weibo.com/wb">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('static/xuetangx/reset.a5f0fbe62f3b.css') }}" />
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('static/xuetangx/forumproject.381f0489b532.css')}}" />
  <!--[if lt IE 9]>
	<script type="text/javascript" src="../static/js/html5shiv.0ce8f355891c.js"  ></script>
	<![endif]-->
 </head>
 <body class=" lang_en">
  <header class="header_index header_not_index" id="header_bootstrap">
   <div id="py_header_data" class="hide" data-ajax="/header_ajax" data-blurajax="/check_register_params_v2" data-loginsubmit="/v2/login_ajax" data-registersubmit="/unify_create_account" data-phonecode="/phone/validate" data-server-time="2016-09-28 02:09:58Z" data-code=""></div>
   <div class="header_container" id="header_container">
    <div class="wrap cf">
     <div class="fl">
      <h1 class="fl"> <a href="../index.htm" data-click="onClick" data-block="GLOBLNAV" data-element="1"> <img src="" title="学堂在线" /> </a> </h1>
      <ul class="cf fl header_container_nav">
       <li><a href="../courses.htm" title="课程" data-click="onClick" data-block="GLOBLNAV" data-element="2">课程</a></li>
       <li><a href="../partners.htm" title="院校" data-click="onClick" data-block="GLOBLNAV" data-element="3">院校</a></li>
       <li class="on"><a href="index.htm" title="广场" data-click="onClick" data-block="GLOBLNAV" data-element="4">广场</a></li>
       <li><a href="../cloud.htm" title="学堂云" data-click="onClick" data-block="GLOBLNAV" data-element="5">学堂云</a></li>
       <li><a  title="雨课堂" data-click="onClick" data-block="GLOBLNAV" data-element="6">雨课堂</a></li>
       <li><a href="../mobile.htm" title="App下载" data-click="onClick" data-block="GLOBLNAV" data-element="7">App下载</a></li>
      </ul>
     </div>
  ...
  <script src="{{ URL::asset('static/xuetangx/js/forumproject.2b2187422a79-1.js') }}"></script>

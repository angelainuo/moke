    ...
    <div class="wrap cf">
        <div class="left fl">
            <div class="post_header">
                <h1>讨论区</h1>
                <a href="{{ URL('./content') }}"    target="_blank" class="view_whole">活动</a>
                <a href="{{ URL('./content') }}"    target="_blank" class="view_whole">分享</a>
                <a href="{{ URL('./content') }}"    target="_blank" class="view_whole">笔记</a>
                <a href="{{ URL('./content') }}"    target="_blank" class="view_whole">资讯</a>
                <a href="{{ URL('./content') }}"    target="_blank" class="view_whole">灌水</a>

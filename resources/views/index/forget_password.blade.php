...
<head>
	...
	<link href="{{ URL::asset('css/media.14fe4c3798ee.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <link rel="stylesheet" type="text/css" href="static/css/media.14fe4c3798ee.css" > -->
...
<header
    ...
    data-server-time="2016-09-28 02:09:47Z"
	data-code=""
	></div>
		...
		<div class="wrap cf">
			<div class="fl">
				...
				<ul class="cf fl header_container_nav">
	                ...
	                <li
					><a "  title="广场" data-click="onClick" data-block="GLOBLNAV" data-element="4">广场</a></li>
	                  <li
...
<footer id="footer_bootstrap">
    ...
    <script src="static/xuetangx/js/appCommon.2ee048cac1c3.js"  ></script>
     <script src="static/xuetangx/js/index.aae84f7c949c.js" ></script>

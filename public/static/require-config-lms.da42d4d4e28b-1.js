;(function (require, define) {
    ...
    if (window.jQuery) {
        ...
        paths.jquery = "http://www.xuetangx.com/static/js/vendor/jquery.min";
    }
    if (window._) {
    ...
    if (window.URI) {
        ...
        paths.URI = "http://www.xuetangx.com/static/js/vendor/URI.min";
    }
    if (window.tinymce) {
        define('tinymce', [], function() {return window.tinymce;});
    } else {
        paths.tinymce = "http://www.xuetangx.com/static/js/vendor/tinymce/js/tinymce/tinymce.full.min";
    }
    if (window.jquery && window.jquery.tinymce) {
        define("jquery.tinymce", [], function() {return window.jquery.tinymce;});
    } else {
        paths.tinymce = "http://www.xuetangx.com/static/js/vendor/tinymce/js/tinymce/jquery.tinymce.min";
    }
    ...
    config = {
        ...
        waitSeconds: 60,
        paths: {
            "annotator_1.2.9": "http://www.xuetangx.com/static/js/vendor/edxnotes/annotator-full.min",
            "date": "js/vendor/date",
            "backbone": "js/vendor/backbone-min",
            "underscore.string": "http://www.xuetangx.com/static/js/vendor/underscore.string.min",
            // Files needed by OVA
            "annotator": "js/vendor/ova/annotator-full",
            "annotator-harvardx": "js/vendor/ova/annotator-full-firebase-auth",
            "http://www.xuetangx.com/static/video.dev": "http://www.xuetangx.com/static/js/vendor/ova/video.dev",
        ...
        shim: {
            ...
            // Needed by OVA
            "http://www.xuetangx.com/static/video.dev": {
                exports:"videojs"
            },
            "vjs.youtube": {
                deps: ["http://www.xuetangx.com/static/video.dev"]
            },
            "rangeslider": {
                deps: ["http://www.xuetangx.com/static/video.dev"]
            },
            ...
            "ova": {
                exports: "ova",
                deps: [
                    "annotator", "annotator-harvardx", "http://www.xuetangx.com/static/video.dev", "vjs.youtube", "rangeslider", "share-annotator",

(function outer(modules, cache, entries) {
    ...
    1: [function(require, module, exports) {
        ...
        analytics.initialize({
            "http://www.xuetangx.com/static/js/appSrc/Segment.io": {
                "apiKey": ""
            }
        }, {
    ...
    154: [function(require, module, exports) {
        ...
        // Setup
        div.innerHTML = '  <link/><table></table><a href="http://www.xuetangx.com/a">a</a><input type="checkbox"/>';
    ...
    164: [function(require, module, exports) {
        ...
        Facade.prototype.enabled = function(integration) {
            var allEnabled = this.proxy('http://www.xuetangx.com/static/js/appSrc/options.providers.all');
            if (typeof allEnabled !== 'boolean') allEnabled = this.proxy('http://www.xuetangx.com/static/js/appSrc/options.all');
            if (typeof allEnabled !== 'boolean') allEnabled = this.proxy('http://www.xuetangx.com/static/js/appSrc/integrations.all');
        ...
        Facade.prototype.ip = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/options.ip');
    ...
    166: [function(require, module, exports) {
        ...
        Group.prototype.name = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/traits.name');
    ...
    167: [function(require, module, exports) {
        ...
        Identify.prototype.name = function() {
            var name = this.proxy('http://www.xuetangx.com/static/js/appSrc/traits.name');
    ...
    168: [function(require, module, exports) {
        ...
        Track.prototype.id = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.id');
        Track.prototype.sku = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.sku');
        Track.prototype.tax = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.tax');
        Track.prototype.name = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.name');
        ...
        Track.prototype.plan = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.plan');
        ...
        Track.prototype.orderId = function() {
            return this.proxy('http://www.xuetangx.com/static/js/appSrc/properties.id') || this.proxy('properties.orderId');
        };
    ...
    169: [function(require, module, exports) {
        ...
        Page.prototype.path = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.path');
        Page.prototype.url = Facade.proxy('http://www.xuetangx.com/static/js/appSrc/properties.url');
        ...
        Page.prototype.referrer = function() {
            return this.proxy('properties.referrer') || this.proxy('http://www.xuetangx.com/static/js/appSrc/context.referrer.url');
        };
    ...
    75: [function(require, module, exports) {
        ...
        var Segment = exports = module.exports = integration('http://www.xuetangx.com/static/js/appSrc/Segment.io')
            .option('apiKey', '');
        ...
        Segment.prototype.normalize = function(msg) {
            ...
            if (!ctx.library) ctx.library = {
                name: 'analytics-1.js'/*tpa=http://www.xuetangx.com/static/js/appSrc/analytics.js*/,
                version: this.analytics.VERSION
            };
            //msg.library = {name: 'analytics-1.js'/*tpa=http://www.xuetangx.com/static/js/appSrc/analytics.js*/, version: this.analytics.VERSION}
    ...
    4: [function(require, module, exports) {
        ...
        exports.VERSION = require('http://www.xuetangx.com/static/js/bower.json').version;

    }, {
        "./analytics": 238,
        "http://www.xuetangx.com/static/js/bower.json": 239
    }],
    238: [function(require, module, exports) {
        ...
        function Analytics() {
            ...
            this._user = user;
            this.log = debug('analytics-1.js'/*tpa=http://www.xuetangx.com/static/js/appSrc/analytics.js*/);
            bind.all(this);
    ...
    252: [function(require, module, exports) {
         ...
         *      // => ["http://www.xuetangx.com/static/js/appSrc/co.uk", "http://www.xuetangx.com/static/js/appSrc/google.co.uk", "http://www.xuetangx.com/static/js/appSrc/www.google.co.uk"]
         *
         * Example:
         *
         *      domain('http://localhost:3000/baz');
    ...
    250: [function(require, module, exports) {
        ...
        var bind = require('bind');
        var defaults = require('defaults');
        var store = require('store-1.js'/*tpa=http://www.xuetangx.com/static/js/appSrc/store.js*/);
        ...
        "bind": 240,
        "defaults": 127,
        "store-1.js"/*tpa=http://www.xuetangx.com/static/js/appSrc/store.js*/: 256
    }],
    256: [function(require, module, exports) {
        ...
        if (isLocalStorageNameSupported()) {
            ...
            try {
                ...
                storageContainer.write('<s' + 'cript>document.w=window</s' + 'cript><iframe src="../../../favicon-1.ico.png"/*tpa=http://www.xuetangx.com/favicon.ico*/></iframe>')
    ...
    239: [function(require, module, exports) {
        module.exports = {
            "name": "analytics-core",
            "version": "2.10.0",
            "main": "analytics-1.js"/*tpa=http://www.xuetangx.com/static/js/appSrc/analytics.js*/,
            "dependencies": {},
            "devDependencies": {}
        };
    }, {}]
